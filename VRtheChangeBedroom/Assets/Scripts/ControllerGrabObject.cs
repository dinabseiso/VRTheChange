...
public class ControllerGrabObject : MonoBehaviour {
    ...
    // Similar toabove, but different because it ensures that the target is set when the player holds a controller over an object for a while. Without this, the collision may fail or become buggy.
